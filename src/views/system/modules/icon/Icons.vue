<template>
  ...
  >
    <a-tabs>
      ...
      <a-tab-pane tab="自定义icon" key="7">
        <ul>
          <li v-for="icon in hicon" :key="icon">
            <h-icon
              :type="icon"
              :title="icon"
  ...
  data() {
    return {
      ...
      hicon: [
        ...
        'icon-fafang',
        'icon-tijiao',
        'icon-jurassic_pass-others',
        'icon-wenjianbohui_caozuo_jurassic',
        'icon-bjiancerenyuan',
        'icon-xz',
        'icon-jingbaobaojing2',
        'icon-jingbaobaojing1',
        'icon-jingbaobaojing',
        'icon-guoqicopy',
        'icon-guoqi1',
        'icon-guoqi',
        ...
        'icon-drxx12',
        'icon-chuanganqi1',
        'icon-chuanganqiguanli',
        'icon-gengduo1',
        'icon-gengduo',
        'icon-yiguoqi',
        'icon-jianchazhong',
        'icon-shiyanhouguanli',
        'icon-shiyanshuju',
        'icon-jianchaqianzhunbei',
        'icon-tianxie',
        'icon-jianmo-zeng',
        'icon-jianmo-jian',
        'icon-chaoqi1',
