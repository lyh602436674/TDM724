 ...
 * @LastEditTime: 2021-12-10 14:47:17
 * @LastEditors: 赵文凯
 * @Description: 环境试验----projectManage
 * @FilePath: \新建文件夹 (2)\tdm200-client\src\views\hifar\hifar-environmental-test\project\Environment.vue
-->
<template>
  <div ref="projectManage" class="h-custom-layout">
