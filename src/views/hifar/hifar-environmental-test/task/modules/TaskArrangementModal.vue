<!--
 * @Author: 雷宇航
 * @Date: 2023-03-10 16:05:20
 * @fileName: TaskArrangementModal.vue
 * @FilePath: tdm724-client\src\views\hifar\hifar-environmental-test\task\modules\TaskArrangementModal.vue
 * @Description:试验安排弹窗V2.0 使用dhtmlx-gantt绘制
-->
<template>
  <div>
